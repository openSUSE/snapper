...
the btrfs filesystem where the backups are stored. Setting "automatic"
...
"snbk list-configs" lists the backup configs.
...
"snbk list" lists the backups for all backup configs. Use the option
...
backed up. If the target state is invalid the transfer from source to
